    ...
    public static void generarXML() {
        try {
            ...
            List<ElementProducte> productes = Arrays.asList(
                    ...
                    new ElementProducte("16", "Truita de patates", 2.5, "Truita de patates casolana.",
                            "truita_patates.png", "Tapa"),
                    new ElementProducte("17", "Calamars a la romana", 3.0, "Calamars a la romana fregits.",
                            "calamars.png", "Tapa"),
                    new ElementProducte("18", "Croquetes de pollastre", 2.8, "Croquetes casolanes de pollastre.",
                            "croquetes_pollastre.png", "Tapa"),
                    new ElementProducte("19", "Braves", 2.5, "Patates braves amb salsa picant.", "braves.png", "Tapa"),
                    new ElementProducte("20", "Pa amb tomàquet", 1.5, "Pa amb tomàquet i oli d'oliva.",
                            "pa_tomaquet.png", "Tapa"),
